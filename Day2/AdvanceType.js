...
/*
Type:
    1. if we want to merge 2 type we used union,
    2. it have union and intersection
    3. not every type is object
    4. we can merge types and interface.
    

interface:
    1. if there is 2 interface of same name, it will indiresctly auto merge
    2. this only extends property and don't have choices such as union
    3. every interface is a type of Object
    4. we can't merge types and interface.
*/
/*
interface Person{
    name:string,
...
*/
var empTuple = ["Mohit Singh", 25, "GeeksforGeeks", 10001];
